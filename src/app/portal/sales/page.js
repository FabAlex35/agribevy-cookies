                            ...
                            <>
                                ...
                                <ul className="nav nav-pills mb-3 mt-3" id="pills-tab" role="tablist">
                                    <li className="nav-item" role="presentation">
                                        <button className={`nav-link ${mode === "farmer" ? "active" : ""}`} id="pills-home-tab" onClick={swicthFarmer}>{translations[app_language]?.farmerSales}</button>
                                    </li>
                                    <li className="nav-item" role="presentation">
                                        <button className={`nav-link ${mode === "buyer" ? "active" : ""}`} id="pills-profile-tab" onClick={swicthBuyer}>{translations[app_language]?.buyerSales}</button>
                                    </li>
                                </ul>
